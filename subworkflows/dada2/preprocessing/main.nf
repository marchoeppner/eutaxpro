...
include { FIND_BEST_TRUNCLEN }                  from './../../../modules/helper/find_best_trunclen'
include { DADA2_QUALITY as DADA2_QUALITY1 }     from './../../../modules/dada2/quality'
...
workflow DADA2_PREPROCESSING {
    ...
    // Trim and filter reads using DADA2
    DADA2_FILTNTRIM(
        ch_trimmed_reads
    )
